@extends('layouts.app')
@section('title', 'Misyon & Vizyon — Eser Spor Kulübü')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @else
            <div class="text-center py-20">
                <i class="fas fa-bullseye text-6xl text-gray-200 mb-4 block"></i>
                <p class="text-gray-400">Henüz misyon & vizyon bilgisi eklenmemiş.</p>
            </div>
        @endif
