...
@section('page_title', 'Haber Listesi')
@section('page_subtitle', 'Tüm haberleri yönetin')

@section('content')

<div class="flex items-center justify-between mb-6">
    <p class="text-sm text-gray-500">
        Toplam <strong>{{ $news->total() }}</strong> haber
    </p>
    <a href="{{ route('admin.news.create', ['type' => 'haber']) }}" class="btn-primary">
        <i class="fas fa-plus mr-2"></i> Yeni Haber
    </a>
</div>
